    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-primary/80 p-4">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h1 className="font-heading text-2xl font-bold text-foreground">Accedi</h1>
        ...
        <Button variant="outline" className="w-full" onClick={() => { toast({ title: "Google OAuth - prossimamente" }); }}>
        ...
        <p className="text-center text-sm text-muted-foreground">
          Non hai un account?{" "}
          <Link to="/register" className="text-accent hover:underline font-medium">Registrati</Link>
        </p>
      </motion.div>
    </div>
  );
