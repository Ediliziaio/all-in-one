          ...
          <CardContent className="p-4 md:p-6 space-y-5 md:space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between gap-3">
                <Label className="flex-1">Mostra profilo in community</Label>
          ...
          <CardContent className="p-4 md:p-6 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex-1">
                  <Label>Push</Label>
                  <p className="text-xs text-muted-foreground">Notifiche push sul browser</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between gap-3">
                <div className="flex-1">
                  <Label>Eventi community</Label>
                  <p className="text-xs text-muted-foreground">Avvisi su nuovi eventi e post</p>
                </div>
                <Switch />
              </div>
              <div className="flex items-center justify-between gap-3">
                <div className="flex-1">
                  <Label>Scadenze pagamenti</Label>
                  <p className="text-xs text-muted-foreground">Reminder prima della scadenza</p>
                </div>
                <Switch defaultChecked />
              </div>
            </div>
