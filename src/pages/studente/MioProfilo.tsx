...
export default function MioProfilo() {
  ...
  return (
    <PageTransition className="p-6 max-w-2xl mx-auto space-y-6">
      <FadeIn><h1 className="font-heading text-2xl font-bold">Il Mio Profilo</h1></FadeIn>
        ...
        <Card>
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2"><Label>Bio <span className="text-muted-foreground text-xs">({bio.length}/200)</span></Label><Textarea value={bio} onChange={(e) => setBio(e.target.value.slice(0, 200))} maxLength={200} /></div>
              ...
              <div className="flex items-center justify-between"><Label>Mostra il mio profilo in community</Label><Switch defaultChecked /></div>
            </div>
